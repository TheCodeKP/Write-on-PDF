...
for the print dialog; the extension does not download a file when you print.
The password itself is kept only in memory while the document is open, and is
never uploaded.

The full policy for this extension only:

https://codekp.com/apps/write-on-pdf/privacy.html
